...
#if defined(BCM2712)
		/* The low reset vector reads this pointer with its MMU/cache off.
		 * cpu_start() separately publishes the selected entry and CPU data. */
		flush_dcache((vm_offset_t)&ResetHandlerData, sizeof(ResetHandlerData), FALSE);
#endif
#endif
